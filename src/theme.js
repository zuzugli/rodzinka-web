export const COLORS = {
  ...
  teal: '#5ECFCF', tealLight: '#D8F5F5', tealDark: '#0E7490',
  peach: '#FBBF97', peachLight: '#FEF0E7', peachDark: '#C2410C',
  sage: '#7EC8A4', sageLight: '#DCFAEC', sageDark: '#065F46',
  ...
  orange: '#FEF0E7', orangeMid: '#FBBF97', orangeDark: '#C2410C',
};
